...
| --- | --- |
| [`pyantra`](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/README.md) | Core workflow engine — graphs, reliability, checkpoints, LLM abstraction. |
| `pyantra-memory` | Vector stores, RAG, and caching. *(planned)* |
| [`pyantra-eval`](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-eval/README.md) | Trajectory evals, LLM judges, pytest plugin. |
...
[`docs/llm.md`](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/llm.md) for the design and roadmap.
...
[`packages/pyantra-core/examples/`](https://github.com/Eskaykaushik/pyantra/tree/main/packages/pyantra-core/examples/):
...
[`packages/pyantra-core/docs/`](https://github.com/Eskaykaushik/pyantra/tree/main/packages/pyantra-core/docs/):

- [Getting started](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/getting-started.md) — install, quickstart, core concepts
- [Graphs and routing](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/graphs.md) — nodes, edges, conditional routing, `END`
- [State merging](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/state.md) — reducers and partial updates with `Annotated`
- [Parallel execution](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/parallel.md) — fan-out/fan-in with reducers
- [Async execution](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/async.md) — `arun()`, mixed sync/async nodes
- [Reliability](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/reliability.md) — retries, backoff, timeouts, `retry_on`
- [Circuit breakers](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/circuit-breakers.md) — thresholds, reset, half-open
- [LLMs](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/llm.md) — provider interface, `MockLLM`, `UsageTracker`
- [Checkpoints](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/checkpoints.md) — memory and SQLite stores, resume
- [Human-in-the-loop](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/human-in-the-loop.md) — `interrupt()` and `resume()`
- [Observability](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/observability.md) — event traces and `Run` results
- [Errors](https://github.com/Eskaykaushik/pyantra/blob/main/packages/pyantra-core/docs/errors.md) — the `PyantraError` hierarchy
